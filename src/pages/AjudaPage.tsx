...
const TUTORIALS: Tutorial[] = [
  ...
  },
  {
    ...
    category: 'Conta',
    summary: 'Entenda como funciona o acesso ao sistema. Após a compra, você recebe um link mágico por email que te autentica automaticamente — sem necessidade de criar senha.',
    steps: [
      { title: 'Verifique seu email após a compra', description: 'Assim que o pagamento é confirmado, o sistema cria automaticamente sua conta e envia um email com o link de acesso para o endereço usado na compra.' },
      { title: 'Clique no link mágico', description: 'O link te autentica instantaneamente sem senha. Você será redirecionado direto para o CRM Dashboard, pronto para começar.' },
      { title: 'Para acessos futuros', description: 'Na tela de login, use a opção "Magic Link": informe seu email e receba um novo link de acesso. Simples, rápido e seguro.' },
      { title: 'Defina uma senha (opcional)', description: 'Se preferir login tradicional, use a opção "Primeiro Acesso" na tela de login para criar uma senha fixa.' },
    ],
    tips: [
      'O link mágico expira após alguns minutos por segurança — solicite um novo se necessário.',
      'Verifique a pasta de spam/lixo eletrônico se não encontrar o email.',
      'Cada link mágico pode ser usado apenas uma vez.',
